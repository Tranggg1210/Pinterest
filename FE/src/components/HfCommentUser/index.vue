...
const rules = {
  content: {
    required: true,
    validator: (_, content) =>
      content?.trim() ? true : new Error('Vui lòng nhập nội dung bình luận cần sửa!'),
    trigger: ['blur', 'input']
  }
};
  ...
  <div class="comemnt-item">
    ...
    <div class="user-comment">
      ...
      <div class="comment-create">
        ...
        <n-dropdown
          trigger="hover"
          :options="isCurrentUser ? options : optionsNotCurrentUser"
          @select="handleSelect"
        >
    ...
    >
      <n-form ref="formRef" :model="commentUpdate" :rules="rules" size="large">
        <n-form-item label="Nội dung bình luận" path="content">
          <n-input
            v-model:value="commentUpdate.content"

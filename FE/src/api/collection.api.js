...
const collectionApi = () => ({
  ...
  getCollectionByPostId: async (id) =>
    api.get(`${ApiConstant.collection.getCollectionByPostId}/${id}`),
  ...
  updateBackground: (id, { file }) =>
    apiUpload.post(`${ApiConstant.collection.updateBackgound}/${id}`, { file }),
  updateCollection: async (id, { name, description }) =>
    api.put(`${ApiConstant.collection.updateCollection}/${id}`, { name, description }),
  deleteCollection: async (id) => api.delete(`${ApiConstant.collection.deleteCollection}/${id}`),
  isCheckSaveCollection: async (id) =>
    api.get(`${ApiConstant.collection.checkSaveCollection}/${id}`)
});

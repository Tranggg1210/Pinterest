...
<template>
  <div>
      ...
      <div class="wide">
        <div class="basic-collection container">
          <div class="collection-background">
            ...
            />
            <img v-else src="@/assets/images/collection.png" alt="background" style="width: 72%" />
          </div>
          ...
          <n-space>
            ...
            <n-dropdown
              ...
              v-if="!collectionInfor?.isDefault"
            >
            ...
            <div v-else class="container">
              <div class="wide posts-container" v-if="posts.length > 0">
                ...
                <HfPost
                  ...
                  :isEdit="false"
                  @updateSavedPosts="removePost"
                  :isNotDefault="collectionInfor.id"
                  v-else
                />
              </div>
              <HfNoData v-else />
    ...
    <n-modal
      ...
      :bordered="false"
    >
      <n-form ref="formRef" :model="collectionForm" :rules="rulesCollection" size="large">
